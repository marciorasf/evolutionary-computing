# -*- coding: utf-8 -*-
"""ga_rastrigin_partial_elitism.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/marciorasf/ComputacaoEvolucionaria-2019.1/blob/master/rastrigin/ga_rastrigin_partial_elitism.ipynb
"""
...
Esse codigo implementa o algoritmo para otimizar a funcao rastrigin
Esse codigo substitui o full rastrigin
Selecao por torneio e roleta como definido
Codigo puramente binario
Usa elitismo definido por um hiper-parametro
...
class Codificacao:
    ...
    def codifica(valor_real, lim_inferior, lim_superior, n_bits):
        ...
        vetor_gray = Codificacao.bin_2_gray(vetor_bin)
        return vetor_gray

    # Retorna um numero real equivalente ao numero binario passado
    @staticmethod
    def decodifica(vetor_gray, lim_inferior, lim_superior, n_bits):
        vetor_bin = Codificacao.gray_2_bin(vetor_gray)
        delta_x = (lim_superior - lim_inferior)/(2**n_bits-1)
        valor_real = 0
...
def run(nvar, fat_ger):
    n_bits = 16
    n_variaveis = nvar
    n_geracoes = 100*fat_ger
    lim_inf = -5.12
    lim_sup = 5.12
    tam_pop = 100
    inclinacao_reta = 1.9
    ...
    return(melhor.rastrigin_valor, ger)