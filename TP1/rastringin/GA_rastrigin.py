...
def GA_rastrigin(ncal, nvar):
    ...
    n_bits = 32
    prob_torneio = 0.5
    inclinacao_reta_ranking = 1.9
    n_variaveis = nvar
    participantes_torneio = 10
    tam_pop = 50
    ...
    constante_tempo_mutacao = (90/100)*n_geracoes/(5) # e atingio 5 constantes de tempo em 70% do total de geracoes
...
#    medias_fitnesses.append(populacao.fitnesses_media())
    ...
    while ger < n_geracoes:
        ...
        Selecao.calcula_probs_ranking(populacao, inclinacao_reta_ranking)
